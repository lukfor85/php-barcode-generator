...
class BarcodeTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $generator = new Lukfor85\Barcode\BarcodeGeneratorPNG();
    ...
    {
        $generator = new Lukfor85\Barcode\BarcodeGeneratorSVG();
    ...
    {
        $generator = new Lukfor85\Barcode\BarcodeGeneratorHTML();
        $generated = $generator->getBarcode('081231723897', $generator::TYPE_CODE_128);
    ...
    {
        $generator = new Lukfor85\Barcode\BarcodeGeneratorJPG();
        $generator->getBarcode('081231723897', $generator::TYPE_CODE_128);
    }

    /**
     * @test
     * @expectedException \Lukfor85\Barcode\Exceptions\InvalidCharacterException
     */
    ...
    /**
     * @test
     * @expectedException \Lukfor85\Barcode\Exceptions\InvalidCheckDigitException
     */
    ...
    /**
     * @test
     * @expectedException \Lukfor85\Barcode\Exceptions\UnknownTypeException
     */
